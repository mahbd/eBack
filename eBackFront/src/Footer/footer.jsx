...
const Sidebar = (props) => {
  ...
  return (
    <footer id="ask-more-ques">
      {email && <div className=" bg-color-1 white ">
        <br/>
            ...
            <div className="row">
              ...
              <div className="col-md-5 pl-md-5">
                ...
                <ul className="site-contact-details text-left">
                  <li>
                    <h4>
                      <span className="text-uppercase white">Email</span>
                    </h4>
                    <p>{email}</p>
                  </li>
                  ...
                  <li>
                    <h4>
                      <span className="text-uppercase white">Address</span>
                    </h4>
                    <div dangerouslySetInnerHTML={{__html: address}}/>
                  </li>
                  <li>
                    <h4>
                      <span className="text-uppercase white">Phone</span>
                    </h4>
                    {phone}
                  </li>
                </ul>
